...
class DataRequest
{
    ...
    public function dadosClientes($param = '')
    {
        if ($param === 'c') {
            ...
            return json_encode($this->DadosClientes);
        }
    }
    ...
    {    
        ...
        if ($param === 'c') {
            ...
            return json_encode($this->DadosFornecedores);
        }
    }
    ...
    public function dadosUsuarios($param = '')
    {
        if ($param === 'c') {
            ...
            return json_encode($this->DadosUsuarios);
        }
    }
}
...
if (isset($_POST['action'])) {
    ...
    $action = $_POST['action'];
    if ($action === 'dadosClientes') {
        $response = $dataRequest->dadosClientes();
        echo $response;
    }

    if ($action === 'dadosUsuarios') {
        $response = $dataRequest->dadosUsuarios();
        echo $response;
    }

    if ($action === 'dadosFornecedores') {
